...
<body class="login">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="text-center" style="padding-top: 40px;">
        ...
        <a href="divA_attendance.php"><button class="btn">Take Attendance</button></a>
        ...
        <div class="collapse mt-3" id="collapseExample">
            <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px; color: white;">Enter student details</h5>
                ...
                <form action="divA.php" method="post">
                  ...
                  <button class="btn btn-primary" data-mdb-toggle="collapse" name="submit">Add</button>
                </form>
        </div>
      </div><br><br><br>
                ...
                if($result = mysqli_query($conn, $sql)){
                    if(mysqli_num_rows($result) > 0){
                        while($row = mysqli_fetch_array($result)){
                                echo "<tr><td>" . $row['name'] . "</td><td>" . $row['sapid'] . "</td><td>" . $row['email'] . "</td><td>" . $row['phone'] . "</td><td><a href='removeA.php?a=$row[sapid]'><button style='background-color: transparent; border: none;'><i class='fas fa-times'></i></button></a></td></tr>";
                        }
